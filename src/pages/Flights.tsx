          ...
          <CardContent className="pt-6 space-y-4">
            ...
            <div className="flex flex-wrap gap-4 pt-2 border-t">
              <div className="flex items-center gap-2">
                <Switch checked={preferences.prefer_nonstop} onCheckedChange={v => updatePreferences({
                prefer_nonstop: v
              })} />
              ...
              <div className="flex items-center gap-2">
                <Switch checked={preferences.needs_window_for_car_seat} onCheckedChange={v => updatePreferences({
                needs_window_for_car_seat: v
              })} />
